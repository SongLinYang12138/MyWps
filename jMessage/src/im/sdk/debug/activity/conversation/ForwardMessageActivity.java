...
public class ForwardMessageActivity extends Activity implements View.OnClickListener {
    ...
    private void initView() {
        et_local_conv_username = (EditText) findViewById(im.sdk.debug.R.id.et_forward_local_username);
        et_local_conv_appkey = (EditText) findViewById(im.sdk.debug.R.id.et_forward_local_appkey);
        et_local_conv_gid = (EditText) findViewById(im.sdk.debug.R.id.et_forward_local_gid);
        et_local_message_id = (EditText) findViewById(im.sdk.debug.R.id.et_forward_message_local_id);
        et_target_conv_username = (EditText) findViewById(im.sdk.debug.R.id.et_forward_target_username);
        et_target_conv_appkey = (EditText) findViewById(im.sdk.debug.R.id.et_forward_target_appkey);
        et_target_conv_gid = (EditText) findViewById(im.sdk.debug.R.id.et_forward_target_gid);
        findViewById(im.sdk.debug.R.id.bt_forward_confirm).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        JMessageClient.forwardMessage(localMsg, targetConv, null, new BasicCallback() {
            @Override
