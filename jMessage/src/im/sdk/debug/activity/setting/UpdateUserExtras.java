...
public class UpdateUserExtras extends Activity implements View.OnClickListener{
    ...
    private static EditText mEt_userExtraKey;
    private static EditText mEt_userExtrasValue;
    private static Button mBt_updateUserExtras;
    private static EditText mEt_userMapKey;
    private static EditText mEt_userMapValue;
    private static Button mBt_updateUserExtrasFromMap;
    private static TextView mTv_getUserExtras;
    private static Button mBt_getUserExtras;
    private static Button mBt_getUserExtra;
    private static EditText mEt_extraKey;
