...
public class UploadProvider extends ContentProvider {
    ...
    private static final String TABLE_NAME = "upload_file";
    private static final UriMatcher URI_MATCHER = new UriMatcher(UriMatcher.NO_MATCH);
    private static final String AUTHORITY = "com.example.ysl.mywps.upload";
    private static final String CONTENT_URI_STRING = "content://" + AUTHORITY + "/" + TABLE_NAME;
    public static final Uri CONTENT_URI = Uri.parse(CONTENT_URI_STRING);
    private UploadSqlite uploadSqlite;
    ...
    public boolean onCreate() {
        ...
        uploadSqlite = new UploadSqlite(getContext(), TABLE_NAME, null, 1);
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        SQLiteDatabase db = uploadSqlite.getReadableDatabase();
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        SQLiteDatabase db = uploadSqlite.getWritableDatabase();
        switch (URI_MATCHER.match(uri)){
    ...
    private class UploadSqlite extends SQLiteOpenHelper {

        public UploadSqlite(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
            super(context, name, factory, version);
        }

        @Override
        public void onCreate(SQLiteDatabase db) {
            String sql = "create table upload_file(" + TransportBean.NAME + " text," + TransportBean.DATE + " VARCHAR(20)," + TransportBean.PATH + " text,"
